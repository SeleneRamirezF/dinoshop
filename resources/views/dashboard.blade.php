<x-app-layout>
    <x-slot name="header">
        <h5 class="font-semibold text-xl text-gray-800 leading-tight" style="color:#411715;">
            {{ 'DINOSHOP' }}
        </h5>
    </x-slot>
        ...
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:70vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('{{ url('storage/img/2358.jpg') }}');">
                    <div class="ml-24 md:w-1/2">
                        <p class=" font-bold text-sm uppercase">Especialistas el artículas jurásicos</p>
                        <p class=" text-4xl font-bold">Tu tienda jurásica favorita!</p>
                        <p class="text-2xl mb-10 leading-none">Para todos los amantes de los dinosaurios</p>
                        <a href="{{ route('contact.create') }}" class="bg-purple-800 py-4 px-8 text-white font-bold uppercase
                        text-xs rounded hover:bg-gray-200 hover:text-gray-800">Contacta con nosotros</a>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:70vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('{{ url('storage/img/fondo2.jpg') }}');">
                    <div class="ml-24 md:w-1/2">
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:70vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom"
                    style="background-image: url('{{ url('storage/img/boy.jpg') }}');">
                    <div class="ml-24 md:w-1/2">
            ...
            <!-- indicadores adicionales para cada diapositiva -->
