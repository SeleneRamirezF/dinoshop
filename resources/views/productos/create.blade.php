<x-app-layout>
    ...
    <div class="container mt-3 mx-auto p-2 w-4/5">
        ...
        <form name="create" method="POST" action="{{ route('productos.store') }}" enctype="multipart/form-data">
            ...
            <x-form-input name="pvp" label="Precio producto (€)" placeholder="Precio" type="number" step='0.01'
                min='0' />
            <x-form-input name="stock" label="Cantidad de producto" placeholder="Cantidad" type="number" step='1'
                min='0' />
